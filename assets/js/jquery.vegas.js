(function($){var $background=$('<img />').addClass('vegas-background'),$overlay=$('<div />').addClass('vegas-overlay'),$loading=$('<div />').addClass('vegas-loading'),$current=$(),paused=null,backgrounds=[],step=0,timer,methods={init:function(settings){var options={src:getBackground(),align:'center',valign:'center',fade:0,loading:true,load:function(){},complete:function(){}}
    ...
    $overlay.prependTo('body');return $.vegas;},slideshow:function(settings,keepPause){var options={step:step,delay:5000,preload:false,backgrounds:backgrounds,walk:function(){}};options=$.extend({},$.vegas.defaults.slideshow,options,settings);if(options.backgrounds!=backgrounds){if(!settings.step){options.step=0;}
